...
" basic configuration {{{
let g:minimal_vimrc = $HOME . "/.minimal.vimrc"
if !filereadable(g:minimal_vimrc)
    echoerr "Can't load my basic configuration. Make sure that " . g:minimal_vimrc . " exists and is readable."
    sleep 2
endif
execute 'source ' . g:minimal_vimrc
" }}}
...
" CollapseMultiplseWhitespaces
function CollapseMultiplseWhitespaces()
    let l = 1
...
command! -bang -nargs=* VimWikiSearch
  \ call fzf#vim#grep(
  \   'rg --column --line-number --no-heading --color=always --smart-case ' . shellescape(<q-args>) . ' $HOME/sync/main/vimwiki $HOME/Documents/knowledge/vimwiki/ $HOME/Documents/bergercookie.github.io/_posts $HOME/sync/bulk/evernote-wiki', 1,
